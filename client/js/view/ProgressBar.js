...
class ProgressBar{
    ...
    constructor() {
        ...
        this.canvas = null, 
        this.ctx = null, //context del canvas
        this.slider = null;
        this.init();
    }
    ...
    drawImage0() {
        app.view.progressBar.drawImage(0);
    };
    ...
    //        slider = document.getElementById('slider');
            ...
            // Load the image
            this.img.src = 'img/progress_tiles206x66.jpg';
        } else {
            app.critical("ProgressBar.init: Canvas not supported!");
        }
    }
}
